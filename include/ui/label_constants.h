...
#define HAND_LABEL_SPLITTING_Y_DEALER (HAND_SPLITTING_Y_DEALER + CARD_HEIGHT/2.f)
#define HAND_LABEL_SPLITTING_Y_PLAYER (HAND_SPLITTING_Y_PLAYER + CARD_HEIGHT/2.f)
#define SPLIT_HAND_LABEL_SPLITTING_Y_PLAYER (SPLIT_HAND_SPLITTING_Y_PLAYER + CARD_HEIGHT/2.f)

#define BET_LABEL_ORIGIN_X (STACK_BUTTON_ORIGIN_X + CHIP_BUTTON_WIDTH*0.5f)
#define BET_LABEL_ORIGIN_Y (STACK_BUTTON_ORIGIN_Y - 60)